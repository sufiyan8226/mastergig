...
export const notFollowedYet = (userId, myself) => {
  if (userId === myself.id) return false; 
  if (myself.following) {
...
const ProfilePage = ({ tagged, liked, saved }) => {
  ...
  return (
    <div className="profile-page-container">
          ...
          <div className="profile-text">
            <div className="profile-username-and-button">
              ...
              {notFollowedYet(profile.user.id, myself) ? (
                ...
                <button className="profile-gig-button"  onClick={e => history.push(`/gigs/all-my-plans`)}>My Gig Plan</button>
                </div>
              ) : (
                <>
            ...
            <div className="profile-numbers">
              ...
              >
                ...
                <span className="profile-number-text"> subscribers</span>
              </div>
              <div
                className="profile-follower-numbers"
              ...
              >
                ...
                <span className="profile-number-text"> subscribing</span>
              </div>
      ...
      {showFollowersModal && (
        <FollowModal listOfUsers={profile.user.followers} title="Subscribers" />
      )}
      {showFollowingModal && (
        <FollowModal listOfUsers={profile.user.following} title="Subscribing" />
      )}
    </div>
  );
};
